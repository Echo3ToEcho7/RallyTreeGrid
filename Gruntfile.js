...
module.exports = function(grunt) {
  ...
  grunt.registerTask('deploy', ['build', 'rallydeploy:demo02']);
  ...
  return grunt.initConfig({
    ...
    concat: {
      src: {
        src: [
          "src/RallyTreeProxy.js",
          "src/RallyTreeModel.js",
          "src/RallyTreeModelFactory.js",
          "src/RallyTreeDataStore.js",
          "src/RallyTreeGrid.js",
          "src/ModifiedPercentDone.js",
          "examples/PH2.js"
        ],
        dest: 'gen/all.js'
      },
    ...
    selenium: {
      options: {
        startURL: "https://demo02.rallydev.com/#/719742d/custom/4229594",
        browsers: ['firefox']
      },
      suite: {
        files: {
